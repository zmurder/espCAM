...
// 相机配置 - ESP32CAM-AITHINKER板型 (OV3660兼容配置)
...
static camera_config_t camera_config = 
{
    ...
    .frame_size = FRAMESIZE_VGA,//FRAMESIZE_QVGA,    // QQVGA-UXGA, For ESP32, do not use sizes above QVGA when not JPEG. The performance of the
